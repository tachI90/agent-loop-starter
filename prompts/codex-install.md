...
2. Decide which adapters are appropriate.
   ...
   - Do not install Cursor adapter files unless the repo also uses Cursor or the user asks for it.
   - Do not install Pi adapter files unless the repo also uses Pi or the user asks for it.
